...
public class CompactDarkGearIndexOverlayView extends CompactDarkOverlayView {

    public CompactDarkGearIndexOverlayView(Ki2ExtensionContext context, PreferencesView preferences, View view) {
