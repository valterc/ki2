...
public class DefaultLightGearSizeOverlayView extends DefaultLightOverlayView {

    public DefaultLightGearSizeOverlayView(Ki2ExtensionContext context, PreferencesView preferences, View view) {
