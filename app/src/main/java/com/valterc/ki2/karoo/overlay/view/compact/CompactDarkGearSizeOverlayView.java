...
public class CompactDarkGearSizeOverlayView extends CompactDarkOverlayView {

    public CompactDarkGearSizeOverlayView(Ki2ExtensionContext context, PreferencesView preferences, View view) {
