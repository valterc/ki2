...
public class RearGearTextFormatter extends SdkFormatter {
    ...
    public RearGearTextFormatter(Ki2Context ki2Context) {
    ...
    public String formatValue(double value) {
        ...
        return DECIMAL_FORMAT.format(shiftingInfo.getRearGear());
    }
}