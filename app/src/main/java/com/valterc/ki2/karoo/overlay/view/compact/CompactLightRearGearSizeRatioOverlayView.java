...
public class CompactLightRearGearSizeRatioOverlayView extends CompactLightOverlayView {

    public CompactLightRearGearSizeRatioOverlayView(Ki2ExtensionContext context, PreferencesView preferences, View view) {
