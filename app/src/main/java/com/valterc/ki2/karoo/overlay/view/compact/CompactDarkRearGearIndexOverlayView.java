...
public class CompactDarkRearGearIndexOverlayView extends CompactDarkOverlayView {

    public CompactDarkRearGearIndexOverlayView(Ki2ExtensionContext context, PreferencesView preferences, View view) {
