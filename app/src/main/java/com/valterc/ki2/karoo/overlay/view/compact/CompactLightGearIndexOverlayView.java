...
public class CompactLightGearIndexOverlayView extends CompactLightOverlayView {

    public CompactLightGearIndexOverlayView(Ki2ExtensionContext context, PreferencesView preferences, View view) {
