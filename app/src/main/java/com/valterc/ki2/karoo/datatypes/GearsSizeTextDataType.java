...
import com.valterc.ki2.karoo.formatters.GearsSizeTextFormatter;
...
public class GearsSizeTextDataType extends Ki2DataType {

    private static final String TYPE_ID = "ki2::gears-size-text";

    private final List<Drawable> drawables;

    public GearsSizeTextDataType(@NonNull Ki2Context context) {
        super(context);
    ...
    public String getDescription() {
        return "Shifting gears size FF-RR (FF Front, RR Rear), example: 54-11.";
    }
    ...
    public SdkFormatter newFormatter() {
        return getKi2Context()
                .getInstanceManager()
                .getOrComputeInstance(GearsSizeTextFormatter.class.getSimpleName(), SdkFormatter.class, () -> new GearsSizeTextFormatter(getKi2Context()));
    }
