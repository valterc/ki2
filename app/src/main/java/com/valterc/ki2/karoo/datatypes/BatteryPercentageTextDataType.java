...
public class BatteryPercentageTextDataType extends Ki2DataType {

    private static final String TYPE_ID = "ki2::battery-percentage-text";

    private final List<Drawable> drawables;

    public BatteryPercentageTextDataType(@NonNull Ki2Context context) {
        super(context);

        this.drawables = FunctionUtils.safeInvoke(() -> Arrays.asList(
                AppCompatResources.getDrawable(getContext(), R.drawable.ic_hh_battery), AppCompatResources.getDrawable(getContext(), R.drawable.ic_hh_gear)));
    }
