...
public class CompactLightGearSizeRatioOverlayView extends CompactLightOverlayView {

    public CompactLightGearSizeRatioOverlayView(Ki2ExtensionContext context, PreferencesView preferences, View view) {
