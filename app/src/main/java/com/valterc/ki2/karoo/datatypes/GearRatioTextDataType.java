...
import com.valterc.ki2.karoo.formatters.GearRatioTextFormatter;
...
public class GearRatioTextDataType extends Ki2DataType {

    private static final String TYPE_ID = "ki2::gear-ratio-text";

    private final List<Drawable> drawables;

    public GearRatioTextDataType(@NonNull Ki2Context context) {
        super(context);
    ...
    public String getDescription() {
        return "Gear ratio between front and rear gears.";
    }
    ...
    public SdkFormatter newFormatter() {
        return getKi2Context()
                .getInstanceManager()
                .getOrComputeInstance(GearRatioTextFormatter.class.getSimpleName(), SdkFormatter.class, () -> new GearRatioTextFormatter(getKi2Context()));
    }
