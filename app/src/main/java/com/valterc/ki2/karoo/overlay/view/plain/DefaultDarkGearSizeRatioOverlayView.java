...
public class DefaultDarkGearSizeRatioOverlayView extends DefaultDarkOverlayView {

    public DefaultDarkGearSizeRatioOverlayView(Ki2ExtensionContext context, PreferencesView preferences, View view) {
